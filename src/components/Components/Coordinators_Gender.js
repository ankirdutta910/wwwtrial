...
function Coordinators_Gender({ collectionName, fieldName }) {
  ...
  useEffect(() => {
    const collectionRef = db.collection("Coordinators"); // Replace collectionName with the name of your Firestore collection
    collectionRef
      .get()
      .then((querySnapshot) => {
        const retrievedData = [];
...
export default Coordinators_Gender;
